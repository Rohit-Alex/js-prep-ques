...
const response = await fetch(
  "https://demo3926231.mockable.io/Ubuyashiki/Amane"
);
...
getAns(); // after how many seconds we will get the consoles?

// 2. New question with same promise as above
const getAns2 = async () => {
...
getAns2(); //Now, after how many seconds we will get the consoles?
